...
- GitHub Actions run 54 was triggered for PR #40. The static-gates and credential-probe jobs failed before any step was recorded (`steps: null`); the failure is runner/infrastructure-level and does not identify a source assertion. SonarQube Cloud separately reports Quality Gate passed.
