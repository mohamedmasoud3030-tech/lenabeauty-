...
export const enBooking = {
  ...
  "Selected staff is not available": "Selected staff is not available",
  "Cannot book a time in the past": "Cannot book a time in the past",
  "Missing required booking fields": "Missing required booking fields",
  "Name and phone are required": "Name and phone are required",
  "Invalid phone number": "Invalid phone number",
  "Missing center id": "Missing center id",
  "You do not have permission to do that.": "You do not have permission to do that.",
  "This client does not belong to this salon.": "This client does not belong to this salon.",
  "This appointment does not belong to this salon.": "This appointment does not belong to this salon.",
  "This service does not belong to this salon.": "This service does not belong to this salon.",
  "Only an administrator can do that.": "Only an administrator can do that.",
